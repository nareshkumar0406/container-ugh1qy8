...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ugh1qy8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ugh1qy8.containers.anotherwebservice.com/
...
```
git clone git@github.com:nareshkumar0406/container-ugh1qy8.git
cd container-ugh1qy8
```
...
```
docker attach container-ugh1qy8
```
